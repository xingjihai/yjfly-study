package com.thirdparty.weixin.base.util;
...
public class FileUpload {
	...
	*/
	...
	/** 微信上传文件接口  */
	public static String uploadFile(String url,File file,String type) throws Exception {
		 String result = null;
	...
	public static void main(String[] args) throws Exception {
		...
		result = FileUpload.uploadFile(url, file, "image");
